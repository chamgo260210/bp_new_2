...
- Contracts: [개요](contracts/CONTRACT_OVERVIEW.md), [Public API 원칙](contracts/PUBLIC_API_PRINCIPLES.md), [Public API v2 JSON 계약](contracts/PUBLIC_API_V2_CONTRACT.md), [Internal AI 원칙](contracts/INTERNAL_AI_API_PRINCIPLES.md), [Internal Spring–AI API v1 계약](contracts/INTERNAL_AI_API_V1_CONTRACT.md), [상태·오류](contracts/STATUS_AND_ERROR_CONTRACT.md), [Provenance](contracts/PROVENANCE_CONTRACT.md)
