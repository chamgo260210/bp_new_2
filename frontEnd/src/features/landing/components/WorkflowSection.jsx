...
export default function WorkflowSection({ onNavigate }) {
  ...
  return <section id="workflow" className="landing-section landing-workflow" aria-labelledby="workflow-title"><div className="landing-container"><p className="landing-eyebrow">HOW IT WORKS</p><h2 id="workflow-title">하나의 문서가,<br />하나의 검증 흐름이 됩니다.</h2><p className="landing-section__lede">사업계획서 등록부터 검토 결과 확인까지, 프로젝트별 진행 상태를 따라 단계적으로 수행합니다.</p><div ref={desktopRef} className="workflow-desktop" tabIndex="0" onKeyDown={onKeyDown} aria-label="5단계 사업 검증 흐름">
